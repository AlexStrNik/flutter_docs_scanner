...
final DynamicLibrary sdkNative = () {
  final DynamicLibrary nativeEdgeDetection =
      Platform.isAndroid ? DynamicLibrary.open("libflutter_docs_scanner.so") : DynamicLibrary.process();
  return nativeEdgeDetection;
}();

final createImageFrame = sdkNative.lookupFunction<_CreateImageFrameNative, _CreateImageFrame>('createImageFrame');

final createImagePlane = sdkNative.lookupFunction<_CreateImagePlaneNative, _CreateImagePlane>('createPlane');

final createImage = sdkNative.lookupFunction<_CreateImageNative, _CreateImage>('createImage');
